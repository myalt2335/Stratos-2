...
pub fn help() {
    ...
    console::write_line("  time (set)    - Show the current time (from RTC)");
...
pub fn version() {
    ...
    console::write_line("Shell 1.A005.08.251011.EXENUS@cfc8a");
...
pub fn panic_cmd(args: &[&str]) {
    match args {
        ...
        _ => {
            console::write_line("Usage: panic yes-i-know [controlled|badmem|double|triple]");
        }
    }
}
